...
with st.container(border=True):
    ...
    if piq_one_check==True:
        ...
        data_to_show.drop(columns=['Date','groupPublished','Compte_cumulé','Year','long','lat','cl_topic','popularity','Unnamed: 0','location','Org','format','uuid','recordOwner'], inplace=True)
        liste_tagNumber_bis = []
